...
[Zhaoying Pan*](https://zhaoyingpan.github.io/), [Daniel Geng*](https://dangeng.github.io/), [Andrew Owens](http://andrewowens.com/)

(* Equal Contributions)


#### [[Arxiv]](https://arxiv.org/abs/) | [[Video]](https://youtube.com/) | [[Website]](https://dangeng.github.io/FlowMag) | [[Data]](https://github.com/)
...
Video Objects (UVO). Check this [repo]() for collecting the dataset on your own with the 
above five datasets. The collected dataset has a size of ~80GB, and you should be able to 
re-generate the same dataset with the scripts. Put the generated dataset in this path
`./data/flowmag`, or modify the `dataroot` in the config file to your dataset root.
...
Download the [model (RAFT)](https://drive.google.com/file/d/1ESSaea-Roe1feFugPFycW5Dd7QCg2ZXR/view?usp=sharing) 
or the [model (ARFlow)](https://drive.google.com/file/d/1m-nE_-3AJ549W3Yemnrm4XeR28tP1sUM/view?usp=sharing) from google drive.
...
If you found this code useful please consider citing our [paper](https://arxiv.org/abs/):
